...
func TestPartitions(t *testing.T) {
	tests := []struct {
		...
		{3, 1, []Partition{{From: 3074457345618258602, To: 6148914691236517204 - 1, NodeIds: []uint32{1}}, {From: 9223372036854775806, To: 12297829382473034408 - 1, NodeIds: []uint32{1}}, {From: 15372286728091293010, To: 18446744073709551612 - 1, NodeIds: []uint32{1}}}},
		{3, 2, []Partition{{From: 6148914691236517204, To: 9223372036854775806 - 1, NodeIds: []uint32{2}}, {From: 12297829382473034408, To: 15372286728091293010 - 1, NodeIds: []uint32{2}}, {From: 18446744073709551612, To: 3074457345618258602 - 1, NodeIds: []uint32{2}}}},
		{4, 1, []Partition{{From: 3074457345618258602, To: 6148914691236517204 - 1, NodeIds: []uint32{1}}, {From: 12297829382473034408, To: 15372286728091293010 - 1, NodeIds: []uint32{1}}}},
		{4, 2, []Partition{{From: 6148914691236517204, To: 9223372036854775806 - 1, NodeIds: []uint32{2}}, {From: 15372286728091293010, To: 18446744073709551612 - 1, NodeIds: []uint32{2}}}},
		{4, 3, []Partition{{From: 9223372036854775806, To: 12297829382473034408 - 1, NodeIds: []uint32{3}}, {From: 18446744073709551612, To: 3074457345618258602 - 1, NodeIds: []uint32{3}}}},
		{0, 1, []Partition{{From: 18446744073709551612, To: 3074457345618258602 - 1, NodeIds: []uint32{2, 1}}, {From: 3074457345618258602, To: 6148914691236517204 - 1, NodeIds: []uint32{1, 2}}, {From: 6148914691236517204, To: 9223372036854775806 - 1, NodeIds: []uint32{2, 1}}, {From: 9223372036854775806, To: 12297829382473034408 - 1, NodeIds: []uint32{1, 2}}, {From: 12297829382473034408, To: 15372286728091293010 - 1, NodeIds: []uint32{2, 1}}, {From: 15372286728091293010, To: 18446744073709551612 - 1, NodeIds: []uint32{1, 2}}}},
		{0, 2, []Partition{{From: 3074457345618258602, To: 6148914691236517204 - 1, NodeIds: []uint32{1, 2}}, {From: 6148914691236517204, To: 9223372036854775806 - 1, NodeIds: []uint32{2, 1}}, {From: 9223372036854775806, To: 12297829382473034408 - 1, NodeIds: []uint32{1, 2}}, {From: 12297829382473034408, To: 15372286728091293010 - 1, NodeIds: []uint32{2, 1}}, {From: 15372286728091293010, To: 18446744073709551612 - 1, NodeIds: []uint32{1, 2}}, {From: 18446744073709551612, To: 3074457345618258602 - 1, NodeIds: []uint32{2, 1}}}},
		{2, 4, []Partition{{From: 18446744073709551612, To: 3074457345618258602 - 1, NodeIds: []uint32{3, 1, 4}}, {From: 3074457345618258602, To: 4611686018427387903 - 1, NodeIds: []uint32{1, 4, 2}}, {From: 4611686018427387903, To: 6148914691236517204 - 1, NodeIds: []uint32{4, 2, 3}}}},
	}
...
func TestExcessPartitions(t *testing.T) {
	...
	for _, test := range tests {
		...
		t.Run(cluster.name, func(t *testing.T) {
			...
			for i, partition := range partitions {
				test.excessPartitions[i].NodeIds = []uint32{test.nodeId}

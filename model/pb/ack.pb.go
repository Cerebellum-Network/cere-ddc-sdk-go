...
type AckRecord struct {
	...
	PublicKey []byte `protobuf:"bytes,2,opt,name=publicKey,proto3" json:"publicKey,omitempty"`
	// user signature
	Singature []byte `protobuf:"bytes,3,opt,name=singature,proto3" json:"singature,omitempty"`
}
...
func (x *AckRecord) GetSingature() []byte {
	if x != nil {
		return x.Singature
	}
	return nil
...
var file_ack_proto_rawDesc = []byte{
	...
	0x12, 0x1c, 0x0a, 0x09, 0x73, 0x69, 0x6e, 0x67, 0x61, 0x74, 0x75, 0x72, 0x65, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x0c, 0x52, 0x09, 0x73, 0x69, 0x6e, 0x67, 0x61, 0x74, 0x75, 0x72, 0x65, 0x42, 0x05,

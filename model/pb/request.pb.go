...
type Request struct {
	...
	// Request ID
	RequestId []byte `protobuf:"bytes,8,opt,name=requestId,proto3" json:"requestId,omitempty"`
}
...
var file_request_proto_rawDesc = []byte{
	...
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09,

...
func (x *SignedPiece) GetPiece() *Piece {
	if x != nil {
		return x.Piece
	}
	return nil
...
var file_signed_piece_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70, 0x62, 0x1a, 0x0b, 0x70, 0x69, 0x65, 0x63, 0x65, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0f, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x5b, 0x0a, 0x0b, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64,
	0x50, 0x69, 0x65, 0x63, 0x65, 0x12, 0x1f, 0x0a, 0x05, 0x70, 0x69, 0x65, 0x63, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x70, 0x62, 0x2e, 0x50, 0x69, 0x65, 0x63, 0x65, 0x52,
	0x05, 0x70, 0x69, 0x65, 0x63, 0x65, 0x12, 0x2b, 0x0a, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74,
	...
	0x75, 0x72, 0x65, 0x42, 0x05, 0x5a, 0x03, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_signed_piece_proto_goTypes = []interface{}{
	...
	(*Piece)(nil),       // 1: pb.Piece
	(*Signature)(nil),   // 2: pb.Signature
}
var file_signed_piece_proto_depIdxs = []int32{
	1, // 0: pb.SignedPiece.piece:type_name -> pb.Piece
	2, // 1: pb.SignedPiece.signature:type_name -> pb.Signature

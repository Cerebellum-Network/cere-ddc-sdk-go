module github.com/Cerebellum-Network/cere-ddc-sdk-go/tests

go 1.19

require (
	github.com/centrifuge/go-substrate-rpc-client/v4 v4.0.8
	github.com/cerebellum-network/cere-ddc-sdk-go/contract v0.1.4
...
replace github.com/cerebellum-network/cere-ddc-sdk-go/contract => ../../cere-ddc-sdk-go/contract
